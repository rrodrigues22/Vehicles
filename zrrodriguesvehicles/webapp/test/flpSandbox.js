		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Veículos",
									"targetURL": "#vehicleszrrodriguesvehicles-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vehicleszrrodriguesvehicles-display": {
								"semanticObject": "vehicleszrrodriguesvehicles",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vehicles.zrrodriguesvehicles",
									"url": sap.ui.require.toUrl("vehicles/zrrodriguesvehicles")
								}
							}
						}
					}
